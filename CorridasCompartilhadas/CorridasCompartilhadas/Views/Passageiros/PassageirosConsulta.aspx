<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PassageirosConsulta.aspx.cs" Inherits="CorridasCompartilhadas.Views.PassageirosConsulta.PassageirosConsulta" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <Columns>         
        <asp:BoundField DataField="IdPassageiro" HeaderText="Id" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg"/>
